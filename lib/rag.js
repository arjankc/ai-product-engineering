...
export async function ragQuery(ai, userQuestion, media = {}) {
  ...
  const systemInstruction = [
    'You are the Travel Log & Itinerary Copilot.',
    'Answer ONLY using the provided CONTEXT from the trip planning vault.',
    'If the context is insufficient, say you do not have that information in the trip notes.',
