...
export async function ragQuery(ai, userQuestion, media = {}) {
  ...
  const systemInstruction = [
    'You are the Local Hardware Troubleshooting Bot.',
    'Answer ONLY using the provided CONTEXT from the local hardware support vault.',
    'If the context is insufficient, say you do not have that information in the local hardware notes.',
