...
app.post('/query', async (req, res) => {
  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        systemInstruction:
          'You are a travel itinerary copilot. Distinguish confirmed bookings from suggestions and respect traveler constraints. If unsure, say you do not know.',
      },
    });
...
app.listen(PORT, () => {
  console.log(`Travel Copilot (Phase 2) → http://localhost:${PORT}`);
});
