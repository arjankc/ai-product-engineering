...
app.post('/query', async (req, res) => {
  ...
  try {
    const response = await ai.models.generateContent({
      ...
      contents: userInput,
      config: { systemInstruction: 'You are Himalayan Game Master. Prefer domain-specific answers and clearly state uncertainty.' },
    });
...
app.listen(PORT, () => console.log(`Himalayan Game Master (Phase 2) → http://localhost:${PORT}`));
