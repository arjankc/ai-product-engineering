...
app.post('/query', async (req, res) => {
  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        systemInstruction:
          'You are a Smart Pantry recipe assistant that respects household allergens. Prefer course-specific answers. If unsure, say you do not know.',
      },
    });
...
app.listen(PORT, () => {
  console.log(`Pantry Architect (Phase 2)  http://localhost:${PORT}`);
});
