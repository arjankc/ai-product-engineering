...
**Problem:** Freelancers and small businesses lose time cleaning expense records and miss deductions because receipts, rules, and monthly summaries live in different places.

## Overview

Build a Nepal-ready bookkeeping assistant grounded in expense policies, tax notes, vendor records, and monthly ledgers. It should cite the household or project vault, identify uncertainty, and avoid inventing records, rules, routes, or actions.
...
- Declare `export_to_sheets(json_data object)`.
- Mock-export one approved expense object as a spreadsheet row; no external service is contacted.
...
| Note | Role |
|------|------|
| `Expense-Policy.md` | Expense Classification Policy |
| `Nepal-Tax-Checklist.md` | Nepal Tax Checklist |
| `July-Ledger.md` | July 2026 Ledger |
| `Vendor-Rules.md` | Vendor and Receipt Rules |
| `Deduction-Examples.md` | Deduction Examples |
| `Monthly-Close.md` | Monthly Close Procedure |
| `Data-Privacy.md` | Financial Data Privacy |
...
```bash
git fetch --tags
git checkout solution-06-phase-2   # example: after Session 7
```
