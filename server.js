...
app.post('/query', async (req, res) => {
  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        systemInstruction:
          'You are a conservative personal fitness and rehabilitation coach. Prioritize clinician restrictions and never diagnose. If unsure, say you do not know.',
      },
    });
...
app.listen(PORT, () => {
  console.log(`Fitness & Rehab Coach (Phase 2) → http://localhost:${PORT}`);
});
