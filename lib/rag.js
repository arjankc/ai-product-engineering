...
export async function ragQuery(ai, userQuestion, media = {}) {
  ...
  const systemInstruction = [
    'You are the Personal Fitness & Rehab Coach.',
    'Answer ONLY using the provided CONTEXT from the fitness and rehabilitation vault.',
    'If the context is insufficient, say you do not have that information in the fitness and rehabilitation notes.',
